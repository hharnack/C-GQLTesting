...
namespace C_GQLTesting.Controllers
{
    ...
    {
        private readonly C_GQLTestingContext _context;

        public PeopleController(C_GQLTestingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'C_GQLTestingContext.Person'  is null.");
            }
            var person = await _context.Person.FindAsync(id);
            if (person != null)
            {
